...
//=============================================================================================================
#define DMA_M2M_TXA     (*(unsigned  int volatile xdata *)0xfa05)
#define DMA_M2M_RXA     (*(unsigned  int volatile xdata *)0xfa07)
...
#define HSPWMA_CFG (*(unsigned char volatile xdata *)0xfbf0)	/* 高速PWMA配置寄存器 */
#define HSPWMA_ADR (*(unsigned char volatile xdata *)0xfbf1)	/* 高速PWMA地址寄存器 */
#define HSPWMA_DAT (*(unsigned char volatile xdata *)0xfbf2)	/* 高速PWMA数据寄存器 */
#define HSPWMB_CFG (*(unsigned char volatile xdata *)0xfbf4)	/* 高速PWMB配置寄存器 */
#define HSPWMB_ADR (*(unsigned char volatile xdata *)0xfbf5)	/* 高速PWMB地址寄存器 */
#define HSPWMB_DAT (*(unsigned char volatile xdata *)0xfbf6)	/* 高速PWMB数据寄存器 */
...
#define HSCLKDIV    (*(unsigned char volatile xdata *)0xfe0b)	/* 高速时钟源分频寄存器 */
...
#define	SPFUNC		(*(unsigned char volatile xdata *)0xfe98)	/* 特殊功能控制寄存器   */
#define	RSTFLAG		(*(unsigned char volatile xdata *)0xfe99)	/* 复位标志寄存器  		*/
...
#define ADCEXCFG    (*(unsigned char volatile xdata *)0xfead)	/* ADC扩展配置寄存器     */
...
#define PWMB_CCR5H  (*(unsigned char volatile xdata *)0xfef5)	/* PWMB比较捕获寄存器1高字节 */
#define PWMB_CCR5L  (*(unsigned char volatile xdata *)0xfef6)	/* PWMB比较捕获寄存器1低字节 */
#define PWMB_CCR6H  (*(unsigned char volatile xdata *)0xfef7)	/* PWMB比较捕获寄存器2高字节 */
#define PWMB_CCR6L  (*(unsigned char volatile xdata *)0xfef8)	/* PWMB比较捕获寄存器2低字节 */
#define PWMB_CCR7H  (*(unsigned char volatile xdata *)0xfef9)	/* PWMB比较捕获寄存器3高字节 */
#define PWMB_CCR7L  (*(unsigned char volatile xdata *)0xfefa)	/* PWMB比较捕获寄存器3低字节 */
#define PWMB_CCR8H  (*(unsigned char volatile xdata *)0xfefb)	/* PWMB比较捕获寄存器4高字节 */
#define PWMB_CCR8L  (*(unsigned char volatile xdata *)0xfefc)	/* PWMB比较捕获寄存器4低字节 */
...
#define PWMB_CCR5   (*(unsigned int  volatile xdata *)0xfef5)	/* PWMA比较捕获寄存器1 16位访问 */
#define PWMB_CCR6   (*(unsigned int  volatile xdata *)0xfef7)	/* PWMA比较捕获寄存器2 16位访问 */
#define PWMB_CCR7   (*(unsigned int  volatile xdata *)0xfef9)	/* PWMA比较捕获寄存器3 16位访问 */
#define PWMB_CCR8   (*(unsigned int  volatile xdata *)0xfefB)	/* PWMA比较捕获寄存器4 16位访问 */
